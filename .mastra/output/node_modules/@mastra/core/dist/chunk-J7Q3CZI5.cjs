...
var MastraLLMV1 = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  async __text({
    ...
    if (experimental_output) {
      ...
      if (chunkDDIY3CRP_cjs.isZodType(experimental_output)) {
    ...
    try {
      const result = await chunkLIRWMGGI_cjs.executeWithContext({
        span: llmSpan,
  ...
  __stream({
    ...
    try {
      return chunkLIRWMGGI_cjs.executeWithContextSync({ span: llmSpan, fn: () => chunkSQINVD7G_cjs.streamText(argsForExecute) });
    } catch (e) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError(
        {
...
//# sourceMappingURL=chunk-J7Q3CZI5.cjs.map
//# sourceMappingURL=chunk-J7Q3CZI5.cjs.map