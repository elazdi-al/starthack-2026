...
export declare class TokenCounter {
    ...
    private readOrPersistFixedPartEstimate;
    private readOrPersistMessageEstimate;
    private resolveToolResultForTokenCounting;
    private estimateImageAssetTokens;
    private estimateImageTokens;
    private estimateImageLikeFileTokens;
    private countAttachmentPartSync;
    ...
    countMessageAsync(message: MastraDBMessage): Promise<number>;
    /**
     * Count tokens in an array of messages
     */
    countMessages(messages: MastraDBMessage[]): number;
    countMessagesAsync(messages: MastraDBMessage[]): Promise<number>;
    /**
