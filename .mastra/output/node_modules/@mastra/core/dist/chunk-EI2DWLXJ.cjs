...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunkCSDJRUU5_cjs.withoutTrailingSlash(
    (_a15 = options.baseURL) != null ? _a15 : "https://api.cerebras.ai/v1"
  );
  const getHeaders = () => chunkCSDJRUU5_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkCSDJRUU5_cjs.loadApiKey({
  ...
  const createLanguageModel = (modelId) => {
    return new chunkCSDJRUU5_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkCSDJRUU5_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunkCSDJRUU5_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkCSDJRUU5_cjs.postJsonToApi({
      url: `${this.config.baseURL}/${this.modelId}`,
      headers: chunkCSDJRUU5_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        prompt,
        num_images: n,
      ...
      failedResponseHandler: chunkCSDJRUU5_cjs.createJsonErrorResponseHandler({
        errorSchema: deepInfraErrorSchema,
        errorToMessage: (error) => error.detail.error
      }),
      successfulResponseHandler: chunkCSDJRUU5_cjs.createJsonResponseHandler(
...
var DeepInfraChatLanguageModel = class extends chunkCSDJRUU5_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunkCSDJRUU5_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunkCSDJRUU5_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunkCSDJRUU5_cjs.lazySchema(
  () => chunkCSDJRUU5_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
        created: v4.z.number().nullish(),
...
function prepareTools({
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new chunkCSDJRUU5_cjs.UnsupportedFunctionalityError({
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunkCSDJRUU5_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunkCSDJRUU5_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    } = await chunkCSDJRUU5_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkCSDJRUU5_cjs.combineHeaders(this.config.headers(), options.headers),
      body: args,
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkCSDJRUU5_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkCSDJRUU5_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: this.failedResponseHandler,
      successfulResponseHandler: chunkCSDJRUU5_cjs.createEventSourceResponseHandler(
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunkCSDJRUU5_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkCSDJRUU5_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkCSDJRUU5_cjs.generateId(),
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkCSDJRUU5_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkCSDJRUU5_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
            ...
            switch (part.type) {
              ...
              case "file": {
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkCSDJRUU5_cjs.convertToBase64(part.data)}`
                  }
                };
              }
            }
...
var groqFailedResponseHandler = chunkCSDJRUU5_cjs.createJsonErrorResponseHandler({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b;
    const warnings = [];
    const groqOptions = await chunkCSDJRUU5_cjs.parseProviderOptions({
      provider: "groq",
      providerOptions,
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkCSDJRUU5_cjs.postJsonToApi({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkCSDJRUU5_cjs.createEventSourceResponseHandler(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_i = toolCall2.function) == null ? void 0 : _i.name) != null && ((_j = toolCall2.function) == null ? void 0 : _j.arguments) != null) {
                    ...
                    if (chunkCSDJRUU5_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_k = toolCall2.id) != null ? _k : chunkCSDJRUU5_cjs.generateId(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_p = toolCall.function) == null ? void 0 : _p.name) != null && ((_q = toolCall.function) == null ? void 0 : _q.arguments) != null && chunkCSDJRUU5_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_r = toolCall.id) != null ? _r : chunkCSDJRUU5_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkCSDJRUU5_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkCSDJRUU5_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkCSDJRUU5_cjs.postFormDataToApi({
      url: this.config.url({
...
var browserSearch = chunkCSDJRUU5_cjs.createProviderDefinedToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkCSDJRUU5_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunkCSDJRUU5_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkCSDJRUU5_cjs.loadApiKey({
        apiKey: options.apiKey,
            ...
            switch (part.type) {
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkCSDJRUU5_cjs.convertToBase64(part.data)}`
                  };
...
var mistralFailedResponseHandler = chunkCSDJRUU5_cjs.createJsonErrorResponseHandler({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunkCSDJRUU5_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunkCSDJRUU5_cjs.parseProviderOptions({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunkCSDJRUU5_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
...
var MistralEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkCSDJRUU5_cjs.TooManyEmbeddingValuesForCallError({
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkCSDJRUU5_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunkCSDJRUU5_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkCSDJRUU5_cjs.loadApiKey({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunkCSDJRUU5_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunkCSDJRUU5_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
function createPerplexity(options = {}) {
  ...
  const createLanguageModel = (modelId) => {
    ...
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunkCSDJRUU5_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunkCSDJRUU5_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const createChatModel = (modelId) => {
    return new chunkCSDJRUU5_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
var xaiFailedResponseHandler = chunkCSDJRUU5_cjs.createJsonErrorResponseHandler({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunkCSDJRUU5_cjs.APICallError({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkCSDJRUU5_cjs.postJsonToApi({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunkCSDJRUU5_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunkCSDJRUU5_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunkCSDJRUU5_cjs.createEventSourceResponseHandler(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunkCSDJRUU5_cjs.convertToBase64(block.data)}`;
...
var webSearchArgsSchema = chunkCSDJRUU5_cjs.lazySchema(
  () => chunkCSDJRUU5_cjs.zodSchema(
    v4.z.object({
...
var webSearchOutputSchema = chunkCSDJRUU5_cjs.lazySchema(
  () => chunkCSDJRUU5_cjs.zodSchema(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunkCSDJRUU5_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.web_search",
  name: "web_search",
  inputSchema: chunkCSDJRUU5_cjs.lazySchema(() => chunkCSDJRUU5_cjs.zodSchema(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunkCSDJRUU5_cjs.lazySchema(
  () => chunkCSDJRUU5_cjs.zodSchema(
    v4.z.object({
...
var xSearchOutputSchema = chunkCSDJRUU5_cjs.lazySchema(
  () => chunkCSDJRUU5_cjs.zodSchema(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunkCSDJRUU5_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.x_search",
  name: "x_search",
  inputSchema: chunkCSDJRUU5_cjs.lazySchema(() => chunkCSDJRUU5_cjs.zodSchema(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider-defined") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunkCSDJRUU5_cjs.validateTypes({
            value: tool.args,
...
var codeExecutionToolFactory = chunkCSDJRUU5_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunkCSDJRUU5_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_image",
  name: "view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunkCSDJRUU5_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  name: "view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
function createXai(options = {}) {
  ...
  const createImageModel = (modelId) => {
    return new chunkCSDJRUU5_cjs.OpenAICompatibleImageModel(modelId, {
      provider: "xai.image",
      url: ({ path }) => `${baseURL}${path}`,
      headers: getHeaders,
      fetch: options.fetch,
...
var ModelsDevGateway = class extends chunkCSDJRUU5_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async fetchProviders() {
    ...
    for (const [providerId, providerInfo] of Object.entries(data)) {
      if (chunkCSDJRUU5_cjs.EXCLUDED_PROVIDERS.includes(providerId)) continue;
      ...
      const hasInstalledPackage = chunkCSDJRUU5_cjs.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunkCSDJRUU5_cjs.createOpenAI({ apiKey, headers: mastraHeaders }).responses(modelId);
      case "gemini":
      case "google":
        return chunkCSDJRUU5_cjs.createGoogleGenerativeAI({ apiKey, headers: mastraHeaders }).chat(modelId);
      case "anthropic":
        return chunkCSDJRUU5_cjs.createAnthropic({ apiKey, headers: mastraHeaders })(modelId);
      case "mistral":
      ...
      case "moonshotai-cn": {
        ...
        return chunkCSDJRUU5_cjs.createAnthropic({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      }
      default: {
        const config = this.providerConfigs[providerId];
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkCSDJRUU5_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        if (npm === "@ai-sdk/google") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkCSDJRUU5_cjs.createGoogleGenerativeAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
...
//# sourceMappingURL=chunk-EI2DWLXJ.cjs.map
//# sourceMappingURL=chunk-EI2DWLXJ.cjs.map