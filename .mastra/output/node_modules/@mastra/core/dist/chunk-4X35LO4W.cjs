...
var scoringEntityTypeSchema = v4.z.enum(["AGENT", "WORKFLOW", ...Object.values(chunkLIRWMGGI_cjs.SpanType)]);
...
var scoreRowDataSchema = v4.z.object({
  ...
  // Timestamps
  ...chunkLIRWMGGI_cjs.dbTimestamps
});
...
var listScoresResponseSchema = v4.z.object({
  pagination: chunkLIRWMGGI_cjs.paginationInfoSchema,
...
var spanTypeField = v4.z.nativeEnum(chunkLIRWMGGI_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var sharedFields = {
  ...chunkLIRWMGGI_cjs.contextFields,
  metadata: chunkLIRWMGGI_cjs.metadataField.nullish(),
  tags: chunkLIRWMGGI_cjs.tagsField.nullish()
};
var spanIds = {
  traceId: chunkLIRWMGGI_cjs.traceIdField,
  spanId: chunkLIRWMGGI_cjs.spanIdField
};
var spanIdsSchema = v4.z.object({
  ...spanIds
});
var omitDbTimestamps = createOmitKeys(chunkLIRWMGGI_cjs.dbTimestamps);
...
var getSpanArgsSchema = v4.z.object({
  traceId: chunkLIRWMGGI_cjs.traceIdField.min(1),
  spanId: chunkLIRWMGGI_cjs.spanIdField.min(1)
...
var tracesFilterSchema = v4.z.object({
  // Date range filters
  startedAt: chunkLIRWMGGI_cjs.dateRangeSchema.optional().describe("Filter by span start time range"),
  endedAt: chunkLIRWMGGI_cjs.dateRangeSchema.optional().describe("Filter by span end time range"),
  // Span type filter
...
var tracesOrderBySchema = v4.z.object({
  ...
  direction: chunkLIRWMGGI_cjs.sortDirectionSchema.default("DESC").describe("Sort direction")
}).describe("Order by configuration");
var listTracesArgsSchema = v4.z.object({
  filters: tracesFilterSchema.optional().describe("Optional filters to apply"),
  pagination: chunkLIRWMGGI_cjs.paginationArgsSchema.default({ page: 0, perPage: 10 }).describe("Pagination settings"),
...
var batchDeleteTracesArgsSchema = v4.z.object({
  traceIds: v4.z.array(chunkLIRWMGGI_cjs.traceIdField)
...
var scoreTracesRequestSchema = v4.z.object({
  ...
  targets: v4.z.array(
    v4.z.object({
      traceId: chunkLIRWMGGI_cjs.traceIdField,
      spanId: chunkLIRWMGGI_cjs.spanIdField.optional()
    })
  ).min(1)
});
...
//# sourceMappingURL=chunk-4X35LO4W.cjs.map
//# sourceMappingURL=chunk-4X35LO4W.cjs.map