...
var chunkPEPNSYRB_cjs = require('../chunk-PEPNSYRB.cjs');
...
var planCounter = 0;
var askUserTool = chunkNQXA2BUF_cjs.createTool({
  id: "ask_user",
...
var submitPlanTool = chunkNQXA2BUF_cjs.createTool({
  id: "submit_plan",
...
var taskWriteTool = chunkNQXA2BUF_cjs.createTool({
  id: "task_write",
...
var taskCheckTool = chunkNQXA2BUF_cjs.createTool({
  id: "task_check",
...
function createSubagentTool(opts) {
  ...
  return chunkNQXA2BUF_cjs.createTool({
    id: "subagent",
...
- The task is self-contained and can be delegated`,
    ...
    execute: async ({ agentType, task, modelId }, context) => {
      ...
      const subagent = new chunkFSGRQN2S_cjs.Agent({
...
var Harness = class {
  ...
  async init() {
    if (this.config.storage) {
      this.#internalMastra = new chunkPEPNSYRB_cjs.Mastra({ logger: false, storage: this.config.storage });
  ...
  async getCurrentModelAuthStatus() {
    ...
    try {
      const { PROVIDER_REGISTRY } = await import('../provider-registry-MKHIXI4D.cjs');
