...
var getTraceStep = chunkEQ7RFQAH_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunk4X35LO4W_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkEQ7RFQAH_cjs.createWorkflow({
