  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkD2F3AOQO_cjs.resolveModelConfig(currentResult.model);
        if (!chunkFSGRQN2S_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunkFSGRQN2S_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-5INB3RBA.cjs.map
//# sourceMappingURL=chunk-5INB3RBA.cjs.map