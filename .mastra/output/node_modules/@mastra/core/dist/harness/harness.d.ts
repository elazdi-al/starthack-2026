...
import type { InferPublicSchema } from '../schema/index.js';
 ...
 * ```
 */
export declare class Harness<TState extends HarnessStateSchema<any> = HarnessStateSchema<{}>> {
    #private;
    readonly id: string;
    private config;
    private stateSchema;
     ...
     */
    setState(updates: Partial<InferPublicSchema<TState>>): Promise<void>;
