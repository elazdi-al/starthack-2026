...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkJ7Q3CZI5_cjs.createStreamFromGenerateResult(result)
    };
  }
...
chunkBVWXTWXP_cjs.__export(dist_exports, {
  ...
  EventSourceParserStream: () => chunkCSDJRUU5_cjs.EventSourceParserStream,
  VERSION: () => VERSION,
  asSchema: () => asSchema,
...
var _a;
var _b;
var DownloadError = class extends (_b = chunkCSDJRUU5_cjs.AISDKError, _a = symbol, _b) {
  constructor({
    url,
    statusCode,
    statusText,
  ...
  static isInstance(error) {
    return chunkCSDJRUU5_cjs.AISDKError.hasMarker(error, marker);
  }
};
...
var createIdGenerator = ({
  ...
  if (alphabet.includes(separator)) {
    throw new chunkCSDJRUU5_cjs.InvalidArgumentError({
      argument: "separator",
...
function handleFetchError({
  ...
  if (error instanceof TypeError && FETCH_FAILED_ERROR_MESSAGES.includes(error.message.toLowerCase())) {
    ...
    if (cause != null) {
      return new chunkCSDJRUU5_cjs.APICallError({
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        if (isAbortError(error) || chunkCSDJRUU5_cjs.APICallError.isInstance(error)) {
          throw error;
        }
...
function loadApiKey({
  ...
  if (apiKey != null) {
    throw new chunkCSDJRUU5_cjs.LoadAPIKeyError({
...
function loadSetting({
  ...
  if (settingValue != null) {
    throw new chunkCSDJRUU5_cjs.LoadSettingError({
...
function standardSchemaValidator(standardSchema) {
  return validator(async (value) => {
    ...
    return result.issues == null ? { success: true, value: result.value } : {
      success: false,
      error: new chunkCSDJRUU5_cjs.TypeValidationError({
        value,
        cause: result.issues
      })
    };
...
async function validateTypes({
  ...
  if (!result.success) {
    throw chunkCSDJRUU5_cjs.TypeValidationError.wrap({ value, cause: result.error });
  }
  return result.value;
}
async function safeValidateTypes({
  ...
  try {
    ...
    return {
      success: false,
      error: chunkCSDJRUU5_cjs.TypeValidationError.wrap({ value, cause: result.error }),
      rawValue: value
    };
  } catch (error) {
    return {
      success: false,
      error: chunkCSDJRUU5_cjs.TypeValidationError.wrap({ value, cause: error }),
      rawValue: value
    };
  }
}
async function parseJSON({
  ...
  try {
    ...
    if (chunkCSDJRUU5_cjs.JSONParseError.isInstance(error) || chunkCSDJRUU5_cjs.TypeValidationError.isInstance(error)) {
      throw error;
    }
    throw new chunkCSDJRUU5_cjs.JSONParseError({ text, cause: error });
  }
}
async function safeParseJSON({
  ...
  try {
    ...
    return {
      success: false,
      error: chunkCSDJRUU5_cjs.JSONParseError.isInstance(error) ? error : new chunkCSDJRUU5_cjs.JSONParseError({ text, cause: error }),
      rawValue: void 0
    };
  }
}
...
function parseJsonEventStream({
  ...
  return stream.pipeThrough(new TextDecoderStream()).pipeThrough(new chunkCSDJRUU5_cjs.EventSourceParserStream()).pipeThrough(
    new TransformStream({
...
var createJsonErrorResponseHandler = ({
  ...
  if (responseBody.trim() === "") {
    return {
      responseHeaders,
      value: new chunkCSDJRUU5_cjs.APICallError({
...
var createEventSourceResponseHandler = (chunkSchema) => async ({ response }) => {
  ...
  if (response.body == null) {
    throw new chunkCSDJRUU5_cjs.EmptyResponseBodyError({});
  }
  return {
    responseHeaders,
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunkCSDJRUU5_cjs.InvalidPromptError({
...
// ../../node_modules/.pnpm/@ai-sdk+azure@2.0.101_zod@4.3.6/node_modules/@ai-sdk/azure/dist/index.mjs
...
var AzureOpenAIGateway = class extends chunkCSDJRUU5_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
  ...
  async resolveLanguageModel({
    ...
    return createAzure({
      ...
      headers: { "User-Agent": chunkCSDJRUU5_cjs.MASTRA_USER_AGENT, ...headers }
    })(modelId);
  }
};
...
function getStaticProvidersByGateway(name2) {
  return Object.fromEntries(Object.entries(chunkZLM2DHS7_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name2));
}
var defaultGateways = [new chunkFS4I22PV_cjs.NetlifyGateway(), new chunkEI2DWLXJ_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkEI2DWLXJ_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkEI2DWLXJ_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkJ7Q3CZI5_cjs.AISDKV5LanguageModel(model);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunkCSDJRUU5_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const modelInstance = chunkCSDJRUU5_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
async function resolveModelConfig(modelConfig, requestContext = new chunk5WBEMKE2_cjs.RequestContext(), mastra) {
  ...
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunkJ7Q3CZI5_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkJ7Q3CZI5_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      this.providerModel = chunkCSDJRUU5_cjs.createOpenAICompatible({
      ...
      const registry = chunkZLM2DHS7_cjs.GatewayRegistry.getInstance();
      ...
      if (normalizedConfig.providerId === "openai") {
        this.providerModel = chunkCSDJRUU5_cjs.createOpenAI({ apiKey }).textEmbeddingModel(
          normalizedConfig.modelId
        );
      } else if (normalizedConfig.providerId === "google") {
        this.providerModel = chunkCSDJRUU5_cjs.createGoogleGenerativeAI({ apiKey }).textEmbedding(
          normalizedConfig.modelId
        );
      } else {
...
//# sourceMappingURL=chunk-D2F3AOQO.cjs.map
//# sourceMappingURL=chunk-D2F3AOQO.cjs.map