...
const segmentedIconClassName = "ui-icon ui-icon-ios";
...
export function MainPageExample() {
  ...
  const utilityButtons = [
    {
      ...
      icon: <ComponentsGlyphIcon className="size-4" tone="muted" />,
    },
    {
      label: "Patterns",
      variant: "outline" as const,
      icon: <Layout className="ui-icon ui-icon-ios ui-icon-muted size-4" weight="fill" />,
    },
    {
      label: "Tokens",
      variant: "secondary" as const,
      className: "bg-muted text-foreground hover:bg-muted/80",
      icon: <Swatches className="ui-icon ui-icon-ios ui-icon-muted size-4" weight="fill" />,
    },
    {
      label: "Playground",
      variant: "ghost" as const,
      className: "text-muted-foreground hover:text-foreground",
      icon: <Sparkle className="ui-icon ui-icon-ios ui-icon-muted size-4" weight="fill" />,
    },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <footer className="mt-8 border-t border-border/50 px-8 py-5">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          <p className="type-caption text-muted-foreground">
            shadcn/ui + Bloom Menu + DialKit
          </p>
          <p className="text-[11px] font-mono text-muted-foreground">2026</p>
        </div>
      </footer>
    </div>
  );
