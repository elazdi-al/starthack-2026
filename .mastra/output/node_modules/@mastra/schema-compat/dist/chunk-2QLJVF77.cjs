...
function getRequire() {
  if (!__require) {
    __require = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-2QLJVF77.cjs', document.baseURI).href)));
  }
  return __require;
}
...
//# sourceMappingURL=chunk-2QLJVF77.cjs.map
//# sourceMappingURL=chunk-2QLJVF77.cjs.map