...
export declare const updateWorkingMemoryTool: (memoryConfig?: MemoryConfigInternal) => import("@mastra/core/tools").Tool<{
    memory: any;
}, unknown, unknown, unknown, import("@mastra/core/tools").ToolExecutionContext<unknown, unknown, unknown>, "update-working-memory", unknown>;
export declare const __experimental_updateWorkingMemoryToolVNext: (config: MemoryConfigInternal) => import("@mastra/core/tools").Tool<{
