...
export declare function formatMessagesForObserver(messages: MastraDBMessage[], options?: ObserverFormatOptions): string;
export declare function buildObserverHistoryMessage(messages: MastraDBMessage[], options?: ObserverFormatOptions): CoreMessage;
/**
 * Format messages from multiple threads for batched observation.
 * Each thread's messages are wrapped in a <thread id="..."> block.
 */
export declare function formatMultiThreadMessagesForObserver(messagesByThread: Map<string, MastraDBMessage[]>, threadOrder: string[], options?: ObserverFormatOptions): string;
export declare function buildMultiThreadObserverHistoryMessage(messagesByThread: Map<string, MastraDBMessage[]>, threadOrder: string[], options?: ObserverFormatOptions): CoreMessage;
