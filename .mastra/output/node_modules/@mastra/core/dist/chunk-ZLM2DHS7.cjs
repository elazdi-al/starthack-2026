...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-ZLM2DHS7.cjs', document.baseURI).href)) || "file://");
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway } = await import('./models-dev-BNMQK7PL.cjs');
      const { NetlifyGateway } = await import('./netlify-3U3NAGJ3.cjs');
...
//# sourceMappingURL=chunk-ZLM2DHS7.cjs.map
//# sourceMappingURL=chunk-ZLM2DHS7.cjs.map